...
def drawPanelBorder():
    pygame.draw.rect(screen, BLACK, (50, 50, 800, 500), 4)
    pygame.draw.rect(screen, BACKGROUND, (50, 0, 800, 50))
    pygame.draw.rect(screen, BACKGROUND, (50, 550, 800, 600))
...
def drawInterface():
    ...
    screen.blit(render_text("RUNx5000", 28), (890, 268))
    screen.blit(render_text("RUNx25000", 28), (890, 338))
    screen.blit(render_text("RUNx100000", 28), (883, 408))
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if 55 < mouse_x < 845 and 55 < mouse_y < 545:
                ...
                try:
                    ...
                    y_train = np.append(y_train, (point[1] / 100))
                except:
                    x_train = np.array([point[0] / 100])
                    y_train = np.array([point[1] / 100])
                error1 = False
